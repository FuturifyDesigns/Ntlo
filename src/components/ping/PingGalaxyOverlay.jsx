      ...
      {transitionActive && (
        ...
        >
          ...
          >
            ...
            <p className="mt-3 font-display text-3xl font-bold text-white sm:mt-4 sm:text-4xl md:text-5xl">Ping</p>
            <p className="mt-1.5 px-2 text-base text-white/80 sm:mt-2 sm:text-lg md:text-xl">
              {t('ping.tagline')}{' '}
